# Amulet — Rootless Deployment (user systemd)
...
> **Use [docs/deploy-ubuntu.md](deploy-ubuntu.md) instead** if your app runs
...
> **Need install steps first?** See [README.md Installation](../README.md#installation).
...
| App runs in Docker / Podman with root daemon | [deploy-ubuntu.md](deploy-ubuntu.md) or [deployment.md](deployment.md) |
...
- `amulet` binary installed — see [README.md Installation](../README.md#installation)
...
- [docs/deploy-ubuntu.md](deploy-ubuntu.md) — root service with `LoadCredential` (system user, no rootless requirement)
