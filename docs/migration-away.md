...
| **Another machine with Amulet** | Re-seal on the new machine (`echo -n "<value>" | amulet seal KEY --file secrets.vault`). See [docs/deployment.md](deployment.md#planned-machine-migration). |
