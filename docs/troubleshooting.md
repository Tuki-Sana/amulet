...
information about *why* decryption failed. See [docs/security.md](security.md)
...
[docs/deployment.md](deployment.md#planned-machine-migration).
...
prompted once per key — enter the same new passphrase each time.
